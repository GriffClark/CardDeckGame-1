...
//instance variables. Most are private beacuse I don't want anything changing the name, value, ect of the cards. 
	private String faceName, suit; //ex "ace of spades"
	 ...
	 */
	public Card(String suit, String face, int faceValue, BufferedImage card, boolean inDeck, boolean inHand, boolean inPlay) { //builds the card passing in value slots
